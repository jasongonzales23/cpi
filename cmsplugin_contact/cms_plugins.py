...
class ContactPlugin(CMSPluginBase):
    ...
    fieldsets = (
        (None, {
            'fields': ('first_name_label', 'last_name_label', 'company_label', 'city_label', 'state_label', 'postal_code_label', 'country_label', 'phone_label', 'company_site_label', 'site_email', 'email_label', 'subject_label', 'content_label', 'thanks', 'submit'),
        }),
        (_('Spam Protection'), {

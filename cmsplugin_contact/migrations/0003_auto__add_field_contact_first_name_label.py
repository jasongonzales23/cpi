...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.first_name_label'
        db.add_column('cmsplugin_contact', 'first_name_label', self.gf('django.db.models.fields.CharField')(default=u'First Name', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.first_name_label'
        db.delete_column('cmsplugin_contact', 'first_name_label')
